...
gVisor and `usbarmory/go-net` are each pinned by both a Go pseudo-version and
source commit. The build copies the authenticated gVisor, x/sys, and TamaGo
modules to temporary directories and applies checked-in bare-metal overlays.
